...
*       gcc -o cardtest2 -g cardtest1.c dominion.o rngs.o $(CFLSGS)
*/
...
int main()
{
    ...
    // TEST 1: Current Players gets exactly 1 card
    printf("TEST 1: current players gets 1 card\n");
