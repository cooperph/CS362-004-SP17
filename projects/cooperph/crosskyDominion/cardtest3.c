...
*       gcc -o cardtest3 -g cardtest1.c dominion.o rngs.o $(CFLSGS)
*/
...
int main()
{
    ...
    int currentPlayerActions, newPlayerActions;
    ...
    // TEST 1: Current Players gets exactly 1 cards
    printf("TEST 1: current players gets 1 cards\n");
    ...
    // TEST 4: Current Player gets 1 additional actions
    printf("\nTest 4: Current Player gets 1 additional actions\n");
    currentPlayerActions = G.numActions;
    newPlayerActions = testG.numActions;
    printf("Original action count: %d\nNew action cound: %d\n", currentPlayerActions, newPlayerActions);
    passedTests += assertTrue( newPlayerActions - currentPlayerActions == newActions);
    totalTests++;
    
    // TEST 5: No state changes for other players (check handsize, decksize, discardsize)
    ...
    // TEST 6: No state changes to Victory Card Piles
    ...
    // TEST 7: No state changes to Kingdom Cards Piles
